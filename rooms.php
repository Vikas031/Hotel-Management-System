        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="navbar-brand logo_h" href="index.html"><h3 style="font-family:cursive; text-decoration: underline;text-align: center;">UV HOTELS</h3></a>
               ...
               <div class="card-header">Room No: <?php echo $row["room_no"]?></div>
                        <div class="card-body">
                            <p class="card-text">Room Status: 
                                <?php if($row["status"]==0){echo "<b>Available</b>";}else{echo "<b>Already Booked</b>";}?></p>
